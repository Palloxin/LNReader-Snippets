...
.replace(/⋮⋮⋮feet\b(?<=\b(?:(?:two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)|(?:twen|thir|for|fif|six|seven|eigh|nine)ty(?:\-(?:one|two|three|four|five|six|seven|eight|nine))?|(?:thir|four|fif|six|seven|eigh|nine)teen|\d+(?:\.\d+)?|(?:a|one)(?! [a⋮])) (?:and a half|hundred|thousand)? ?⋮⋮⋮feet)/g, 'ↂↂfeet')
.replace(/ↂↂfeet(?<=\b([\w\-]+\b(?:\.\d+)?|a)( and a half| (hundred|thousand))? ↂↂfeet)/g, (_, a,b,c) => {
...
//jsfidle: https://jsfiddle.net/19wf0cvm/
//////↑↑↑↑↑ — END
