...
.replace(/⋮⋮⋮feet\b(?<=\b(?<!\-)(?:(?:two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)|(?:twen(?=ty)|thir|fou?r|fif|six|seven|eigh|nine)(?:teen|ty)(?:(?<=ty)\-(?:one|two|three|four|five|six|seven|eight|nine))?|\d+(?:\.\d+)?|(?:a|one)(?= (?:hundred|thousand)))\b( and a half| (hundred|thousand))? ⋮⋮⋮feet)/g, 'ↂↂfeet')
