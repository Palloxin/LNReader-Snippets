...
.replace(/⋮⋮⋮feet\b(?<=((?<!\-)((?:twen(?=ty)|thir|fou?r|fif|six|seven|eigh|nine)(?:teen|ty)(?:(?<=ty)\-(?:one|two|three|four|five|six|seven|eight|nine))?|(?:two|three|four|five|six|seven|eight|nine|ten|eleven|twelve))\b|(?:a|one)(?<=[^a-z\-][a-z]+) (?=hundred|thousand)|\d+(?:\.\d+)?)( and a half|(hundred|thousand))? ⋮⋮⋮feet)/g, (_, a,b,c) => {
	let multip = 1;
