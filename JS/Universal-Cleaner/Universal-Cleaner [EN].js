...
////↓↓↓↓↓
//’d => had
.replace(/’d\b(?<=\b[A-Za-z]+’d)\s(?=(?:(?:all|al(?:most|ready|so|ways)|additionally|accidentally|actually|actively|basically|both|barely|clearly|completely|certainly|casually|deliberately|decisively|definitely|eve[nr]|essentially|evidently|easily|finally|forcibly|first|half|initially|instantly|inadvertently|just|long|previously|mostly|naturally|nearly|never|not|originally|obviously|once|only|often|personally|probably|previously|recently|really|rarely|still|somehow|successfully|slowly|suddenly|totally|then|truly|unfortunately|at least|long since)\s)?((?:half-)?[a-z]+ed(?<!(?:e|\b[^])ed)|agreed|beaten|[bs]een|begun|bent|bitten|bled|blown|broken|bred|br?ought|built|burnt|caught|chosen|[dg]one|dug|drawn|dreamt|dr[au]nk|driven|eaten|fallen|fed|felt|fought|found|flown|forgotten|forgiven|freed|frozen|got|given|grown|had|heard|hidden|held|kept|known|laid|led|leant|left|lent|lost|made|meant|met|misheard|mistaken|misunderstood|now|overseen|paid|ridden|rung|risen|said|sold|sp?ent|shaken|shone|shod|shot|shown|shrunk|sung|sunk|sat|slept|spoken|spilt|sped|stood|stolen|str?uck|stung|stunk|sworn|sought|swept|swum|swung|taken|taught|torn|told|thought|thrown|understood|woken|woven|won|written|worn)\b)/g, ' had ')
...
.replace(/’s\b(?<=\b[A-Za-z]+’s)\s(?=(?:[a-z]+ed(?<!(?:e|\b[^])ed)|agreed|beaten|[bs]een|begun|bent|bitten|bled|blown|broken|bred|br?ought|built|burnt|caught|chosen|[dg]one|dug|drawn|dreamt|dr[au]nk|driven|eaten|fallen|fed|felt|fought|found|flown|forgotten|forgiven|freed|frozen|got|given|grown|had|heard|hidden|held|kept|known|laid|led|leant|left|lent|lost|made|meant|met|misheard|mistaken|misunderstood|now|overseen|paid|ridden|rung|risen|said|sold|sp?ent|shaken|shone|shod|shot|shown|shrunk|sung|sunk|sat|slept|spoken|spilt|sped|stood|stolen|str?uck|stung|stunk|sworn|sought|swept|swum|swung|taken|taught|torn|told|thought|thrown|understood|woken|woven|won|written|worn)\s(?:me|them|us|her|hi[ms]|its?|my|your|our)\b)/g, ' has ')//no 'their'
