...
////↓↓↓↓↓
//’d => had
.replace(/’d\b(?<=\b[A-Za-z]+’d)\s(?=(?:(?:all|al(?:most|ready|so|ways)|actively|both|barely|clearly|completely|certainly|casually|deliberately|decisively|definitely|eve[nr]|evidently|easily|forcibly|first|half|instantly|inadvertently|just|(?:actu|accident|addition|basic|essenti|fin|initi|just|natur|origin|person|successf)[au]lly|long|previously|mostly|nearly|never|not|obviously|once|only|often|probably|previously|recently|really|rarely|still|somehow|slowly|suddenly|totally|then|truly|unfortunately|at least|long since)\s)?((?:half-)?[a-z]+ed(?<!(?:e|\b[^])ed)|agreed|[bs]een|br?ought|built|began|broken|beaten|bitten|chosen|caught|driven|drawn|dr[au]nk|dealt|dug|[dg]one|eaten|found|felt|flown|forgotten|fought|fallen|freed|fed|gotten|got|given|grown|hidden|held|heard|kept|known|led|left|lent|learnt|lost|laid|made|met|meant|misunderstood|now|overseen|paid|ridden|sp?ent|spoken|slept|said|stolen|sunk|shown|smelt|sold|str?uck|stood|sought|taken|taught|thought|thrown|told|understood|written|woven|woken|won|worn)\b)/g, ' had ')
.replace(/’d(?<=\b[A-Za-z]+’d)\s(?=(?:(?:all|al(?:most|ready|so|ways)|actively|both|barely|clearly|completely|certainly|casually|deliberately|definitely|eve[nr]|evidently|easily|forcibly|first|half|instantly|inadvertently|just|(?:actu|accident|addition|basic|essenti|fin|initi|natur|origin|person|successf)[au]lly|long|previously|mostly|nearly|never|not|obviously|once|only|often|probably|previously|recently|really|rarely|still|somehow|slowly|suddenly|totally|then|truly|unfortunately|at least|long since)\s)?(?:had\s))/g, ' had ')

.replace(/’d\s(?=(?:previously|recently)\s(?:become|bet|come|cost|cut|hit|hurt|let|put|quit|read|run|set|shut|spread)\b|(?<=\b(?:[Ee]ver since) [A-Za-z]+’d.))/g, ' had ')

//’s => has
.replace(/’s\b(?<=\b[A-Za-z]+’s)\s(?=(?:(?:all|al(?:most|ready|so|ways)|actively|both|barely|clearly|completely|certainly|casually|deliberately|definitely|eve[nr]|evidently|easily|forcibly|first|half-?|instantly|inadvertently|just|(?:actu|accident|addition|basic|essenti|fin|initi|natur|origin|person|successf)[au]lly|long|previously|mostly|nearly|never|not|obviously|once|only|often|probably|previously|recently|really|rarely|still|somehow|slowly|suddenly|totally|then|truly|unfortunately|at least|long since)\s)?(?:(?:exist|happen|remain)ed|been|become|began|got|had)\b(?=\s))/g, ' has ')
.replace(/’s\b(?<=\b[A-Za-z]+’s)\s(?=(?:[a-z]+ed(?<!(?:e|\b[^])ed)|agreed|[bs]een|br?ought|built|began|broken|beaten|bitten|chosen|caught|driven|drawn|dr[au]nk|dealt|dug|[dg]one|eaten|found|felt|flown|forgotten|fought|fallen|freed|fed|gotten|got|given|grown|hidden|held|heard|kept|known|led|left|lent|learnt|lost|laid|made|met|meant|misunderstood|now|overseen|paid|ridden|sp?ent|spoken|slept|said|stolen|sunk|shown|smelt|sold|str?uck|stood|sought|taken|taught|thought|thrown|told|understood|written|woven|woken|won|worn)\s(?:me|them|us|her|hi[ms]|its?|my|your|our)\b)/g, ' has ')//no 'their'
