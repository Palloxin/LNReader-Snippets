...
.replace(/[^\B_](?<!:|\d-)(?=(?:[1-9]|1[012]|0\d(?=:\d))(?::[0-5]\d\b)?(?:-| ?[AaPp]\.?[mM](?=\.[^\.]|\b)))/g, '••••')//♦
...
.replace(/\b(?:[1-9]|1[01]|[A-Za-z]+) o’clock(\d+)( (?:at|in the)(?<=\D(?:[7-9]|1[01]) (?:at|in the)) (?:night|evening)| in(?<=[1-9] in) the afternoon)?\b/g, (_, a,b) => `${b?+a+12:a} o’clock${b||''}`)
//↑
